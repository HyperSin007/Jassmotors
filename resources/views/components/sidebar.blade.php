...
<div class="fixed inset-y-0 left-0 w-64 flex flex-col bg-gray-900 border-r border-gray-800 z-30">
    <div class="flex h-16 flex-shrink-0 items-center px-4 border-b border-gray-800">
    ...
    <div class="border-t border-gray-800 p-4">
        <div class="flex items-center gap-x-4">
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="rounded-md bg-gray-800 p-2 text-gray-400 hover:text-white">
